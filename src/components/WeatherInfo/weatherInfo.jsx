  ...
  <table className="weather-info">
    ...
    <tbody>
      <tr className="weather-info__tr">
        ...
        <td className="weather-info__td weather-info__temperature">{!data ? 'N/A' : data.temp}</td>
        ...
        <td className="weather-info__td weather-info__pressure">{!data ? 'N/A' : data.pressure}</td>
        <td className="weather-info__td weather-info__humidity">{!data ? 'N/A' : data.humidity}</td>
      </tr>
    </tbody>
  </table>
);
